...
function countNiceStrings(strings) {
    ...
    function isNice(str) {
        ...
        for (let i = 0; i < str.length; i++) {
            ...
            if (i > 0 && forbidden.includes(str[i - 1] + str[i])) {
                hasForbidden = true;
                break;
            }
        }
...
console.log(countNiceStrings(strings)); // Output: 2

function countNiceStringsNewRules(strings) {
    function isNice(str) {
        let hasPair = false;
...
// Example usage:
console.log(countNiceStringsNewRules(strings)); // Output will vary based on the input
